...
class AndroidMessage extends Base
{
    ...
    public function pushOffLineMsg()
    {
        ...
        $result = Result::getOfflineResult(Category::CLIENT_TYPE_ANDROID, $code, $syncStamp);
        $this->messageBase($result);
        return true;
    }
    ...
    {
        [$toUid, $noceAck,$syncStamp] = Params::ReceivedParams(Category::CLIENT_TYPE_ANDROID, $this->body['to_uid'], $this->body['noce_ack'], $this->body['syncstamp']);
        ...
        $result = Result::getReadOffLineMsg(Category::CLIENT_TYPE_ANDROID, 200, $syncStamp);
        $this->messageBase($result);
        return true;
    }
